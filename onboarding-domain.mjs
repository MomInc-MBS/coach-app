...
// Rank 4: a region may also carry a decoupled texture+colour choice (see design.ts's
// MaterialChoice/parseRecipe, which this mirrors). Optional and additive - old recipes
