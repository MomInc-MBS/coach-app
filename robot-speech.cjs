...
const PROFILE={voice:'en-us',wordsPerMinute:125,pitch:52,pitchRange:38,wordGap:1};
...
function synthesize(text){
 ...
 const task=new Promise((resolve,reject)=>{
  ...
  const child=execFile(ENGINE,args,{encoding:'buffer',windowsHide:true,timeout:5000,maxBuffer:5*1024*1024},(error,wav)=>{
...
module.exports={synthesize,PROFILE,available:()=>fs.existsSync(ENGINE)};
