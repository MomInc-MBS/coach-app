...
export function initPod({voice,movements,onStop,onNext}){
 ...
 function syncCombat(){flow.weapon=arena.weapon;const p=flow.combat,line=$('restFeedback');if(!line.textContent)line.textContent=p?`${flow.attackDamage} dmg / hit · ${p.loginStreak}-day streak${p.breathingCompleted?' · ×100 breath':''}`:`${flow.attackDamage} dmg / hit`;}
