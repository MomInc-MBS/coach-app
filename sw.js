...
const FILES=['/scoreboard.mjs','/scoreboard-domain.mjs','/scoreboard.css','/movement-setup.mjs','/personal-tracker.mjs','/personal-tracker.css','/pod/mom-inc-mark.png','/app-updates.mjs','/release-info.mjs','/exercise-library.mjs','/movement-rules.mjs','/exercise-demo.mjs','/demo-poses.mjs','/hologram.mjs','/focus-library.css',"/handborne/assets/fflate.module-BTK1vOXE.js","/handborne/assets/GLTFExporter-CL_WC7Dc.js","/handborne/assets/hand-entry-B7K7J180.js","/handborne/assets/hand-entry-BySRDxUO.css","/handborne/assets/OBJExporter-J3SdsgWZ.js",'/hand-companion.mjs','/hand-companion.css','/handborne/companion.mjs','/handborne/index.html','/auth-client.mjs','/auth-paths.mjs','/device-notifications.mjs','/nutrition.mjs','/nutrition-data.mjs','/meal-nutrition.mjs','/reminder-live.mjs','/food-live.css','/icons/myr5-alien-apple.png','/icons/myr5-alien-maskable.png','/office-quick-form.mjs','/office-domain.mjs','/office-form.mjs','/onboarding-domain.mjs','/onboarding-questions.mjs','/coach-profile.mjs','/pose.html','/manifest.webmanifest','/menu.css','/launch.css','/launch.mjs','/launch-shell.mjs','/flip-display.mjs','/flip-display.css','/achievements.mjs','/app.mjs','/coach.mjs','/robot-audio.mjs','/camera.mjs','/menu.mjs','/movement-engine.mjs','/pod/pod.mjs','/pod/pod.css','/pod/set-flow.mjs','/pod/identity.mjs','/pod/encouragement.mjs','/pod/gala-avatar.js','/icons/myr5-alien-192.png','/icons/myr5-alien-512.png'];
...
self.addEventListener('push',event=>{let data={title:'MYR5 Coach',body:'Your coach has a reminder.',url:'/pose.html'};try{data={...data,...event.data.json()};}catch{}event.waitUntil(self.registration.showNotification(String(data.title).slice(0,80),{body:String(data.body).slice(0,200),icon:'/icons/myr5-alien-192.png',badge:'/icons/myr5-alien-192.png',tag:data.tag||'myr5-reminder',data:{url:data.url},renotify:false}));});
self.addEventListener('notificationclick',event=>{event.notification.close();event.waitUntil((async()=>{const url=new URL(event.notification.data?.url||'/pose.html',self.location.origin);if(url.origin!==self.location.origin)return;const all=await self.clients.matchAll({type:'window',includeUncontrolled:true});for(const client of all)if(new URL(client.url).origin===url.origin){await client.navigate(url.href);return client.focus();}return self.clients.openWindow(url.href);})());});
