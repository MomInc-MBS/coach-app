...
export function mountMeditation({api,onComplete,getAccount,backgroundLookup}={}){
 ...
 const scene=dialog.querySelector('[data-meditation-scene]'),stage=dialog.querySelector('.meditation-stage'),character=dialog.querySelector('.meditation-character'),speech=dialog.querySelector('.meditation-speech'),arcade=dialog.querySelector('[data-meditation-arcade]'),breathPause=dialog.querySelector('[data-breath-pause]');let taps=0,game=null,timers=[],transitioning=false;
 ...
 mountBreathing({dialog,scene,pause:breathPause,api,onComplete,getAccount});
